          ...
          <table className="w-full text-xs border border-gray-200 rounded-lg overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-100">
              <tr>
                ...
                <td className="px-3 py-2 text-gray-500">path param</td>
                <td className="px-3 py-2 text-gray-600">Código do produto (URL-encoded)</td>
              </tr>
            </tbody>
          </table>
        </div>
            ...
            <tbody className="divide-y divide-gray-100 text-gray-700">
              {[
                ...
                <tr key={field}>
                  ...
                  <td className="px-3 py-2 text-gray-500 font-mono">{type}</td>
